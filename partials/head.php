...
<body>
    <div id="wrapper">
                ...
                <div class="container-lg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-md-1 d-none d-md-block">
                            <a id="cart" class='fas fa-shopping-bag' href="cart.php"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid bg-white">
            <div class="container-lg">
                <div class="row">
                    <div class="col-3 d-md-none d-sm-block navbar-light bg-white">
                    ...
                    <div class="d-md-none d-sm-block col-2">
                        <div id="cog" class="dropdown">
                            ...
                            <div class="dropdown-menu ">
                                <a class="dropdown-item pl-1" href="cart.php">Checkout</a>
                        ...
                        <ul class="col-lg-12 col-md-12 navbar-nav  nav-justified">
                            <?php while ($categories_record = mysqli_fetch_assoc($categories_recordset)) { ?>
                                <li class="nav-item mr-lg-3 mr-md-2">
                                    <a class="nav-link" href="<?= $categories_record['alias'] ?>products.php"><?= $categories_record['name'] ?></a>
                                </li>
                            <?php } ?>
                            <!-- <li class="nav-item mr-lg-3 mr-md-2">
